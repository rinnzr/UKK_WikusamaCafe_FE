...
function TambahTransaksi() {
  ...
  return (
    ...
    <h1 className="flex justify-center font-semibold text-3xl">Tambah Transaksi</h1>

    <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4 mx-14 sm:p-5">
      {/* Tanggal Transaksi */}
      <div className="">
        <label className="block mb-1 font-bold text-gray-900">Tanggal Transaksi:</label>
        <input 
          type="date"
          value={tglTransaksi}
      ...
      {/* Nomor Meja */}
      <div>
        <label className="block mb-1 font-bold text-gray-900">Nomor Meja:</label>
        <select
          value={idMeja}
      ...
      {/* Nama Pelanggan */}
      <div>
        <label className="block mb-1 font-bold text-gray-900">Nama Pelanggan:</label>
        <input
          type="text"
          value={namaPelanggan}
      ...
      {/* Status Pembayaran */}
      <div>
        <label className="block mb-1 font-bold text-gray-900">Status Pembayaran:</label>
        <select
          value={status}
