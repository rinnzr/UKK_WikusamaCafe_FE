    ...
    <>
      <div className="container px-14 py-36 mx-auto ">
        ...
        <p className="max-w-2xl mx-auto mt-4 text-center  xl:mt-6 text-[#0B2447]">
          Selamat Bekerja Admin jangan lelah ya, kalo lelah itu ngejar dia tapi
          ga dapet Admin kamu hanya bisa CRUD di semua asset, kalo ngerubahin
          dia biar suka jangan deh
        </p>
        <div className="grid grid-cols-1 gap-8 mt-6 xl:mt-12 xl:gap-12 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="w-full p-8 space-y-8 text-center bg-[#CD104D] rounded-lg ">
            <p className="font-medium  uppercase text-gray-200">User</p>

            <h2 className="text-5xl font-bold uppercase text-white">{user}</h2>
