...
export default class Meja extends React.Component {
  ...
  saveMeja = (event) => {
    ...
    if (this.state.action === "insert") {
      ...
      axios
        .put(baseURL, sendData, this.headerConfig())
        .then((response) => {
          window.alert(response.data.message);
          this.getMeja();
        })
  ...
  render() {
    return (
      <div className="flex pr-4 h-screen py-10  w-full">
        <div className="w-full ">
          {/* <Sidebar /> */}
          <div className=" overflow-x-auto sm:rounded-lg">
            <button
              className="hover:bg-green-500 float-right bg-green-600 text-gray-50 font-bold uppercase text-sm px-4 py-3 mb-2 rounded-md outline-none ease-linear transition-all duration-150"
              type="button"
              onClick={() => this.Add()}
            >
              Tambahkan Meja
            ...
            <table class="min-w-full text-sm text-left text-gray-700">
              <thead class="text-xs text-gray-100 uppercase bg-amber-500">
                <tr className="text-base">
                  ...
                  <th scope="col" className="px-6 py-3 flex items-center">
                    Status Meja
                    <a href="#" onClick={() => this.status()} id="icon1">
                      <svg
                    ...
                    >
                      <li>
                        <a
                          ...
                          class="block px-4 py-2  hover:bg-gray-600 hover:text-gray-50"
                        >
                          Tampilkan Semua
                        </a>
                      </li>
                      <li>
                        <a
                          href="#"
                          onClick={() => this.getMejaStatus("terisi")}
                          className="block px-4 py-2  hover:bg-gray-600 hover:text-gray-50"
                        >
                          terisi
                        </a>
                      </li>
                      <li>
                        <a
                          href="#"
                          onClick={() => this.getMejaStatus("kosong")}
                          className="block px-4 py-2  hover:bg-gray-600 hover:text-gray-50"
                        >
                          kosong
                        </a>
              ...
              <tbody>
                {this.state.meja.map((item) => (
                  <tr
                    className="bg-amber-100 border-b font-sans  border-gray-700"
                    key={item.id_meja}
                  >
                    ...
                    <td className="px-6 py-4 text-center flex justify-evenly">
                      <a
                        href="#"
                        className="inline-flex font-medium text-xl text-blue-500 hover:underline"
                      ...
                      <a
                        href="#"
                        className="font-medium text-xl text-red-500 hover:underline"
        ...
        <div
          id="modal_meja"
          className="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 md:inset-0 h-modal md:h-full bg-tranparent bg-black bg-opacity-50"
        >
