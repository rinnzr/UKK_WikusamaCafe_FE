    ...
    return (
      <div className="w-full p-8 h-screen ">
        <div className=" overflow-x-auto sm:rounded-lg">
          <h1 className="flex justify-center font-medium text-5xl">
            Meja List
          </h1>
          <button
            className="hover:bg-green-500 float-right bg-green-600 text-white font-bold uppercase text-sm px-4 py-3 mb-2 rounded-md outline-none ease-linear transition-all duration-150"
            type="button"
            onClick={() => this.Add()}
          >
            Tambah Meja
          ...
          <table class="min-w-full text-sm text-left text-gray-700">
            ...
            <tbody>
              {this.state.meja.map((item) => (
                <tr
                  className="bg-orange-200 border-b font-sans  border-gray-700 hover:bg-orange-100"
                  key={item.id_meja}
                >
                  ...
                  <td className="px-6 py-4 text-center flex justify-evenly">
                    <a
                      href="#"
                      className="inline-flex font-medium text-blue-500 hover:underline"
