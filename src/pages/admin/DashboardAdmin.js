      ...
      <section className="p-6  text-gray-100">
        <div className="mx-auto">
          ...
          <div className="grid gap-6 my-16 lg:grid-cols-3">
            <div className="flex flex-col p-8 space-y-4 rounded-md bg-yellow-700">
              <p className="text-2xl font-semibold">
                <b>{menus}</b>
                <p>Menu</p>
              </p>
            </div>
            <div className="flex flex-col p-8 space-y-4 rounded-md bg-yellow-800">
              <p className="text-2xl font-semibold">
                <b>{user}</b>
                <p>User</p>
              </p>
            </div>
            <div className="flex flex-col p-8 space-y-4 rounded-md bg-yellow-900">
              <p className="text-2xl font-semibold">
                <b>{mejas}</b>
                <p>Meja</p>
              </p>
